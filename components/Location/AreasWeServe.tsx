...
const AreasWeServe = () => {
  ...
  return (
    <>
      <div className="location-area style-two position-relative z-1 pt-120">
        <div className="container">
          ...
          <div className="location-box bg-gray round-10">
            <form
            ...
            >
              <div className="form-group position-relative">
                <input
                  type="search"
                  className="w-100 ht-48 bg-white round-10 border-0 text-para outline-0"
                  placeholder="Search"
                  value={searchTerm}
